      ...
      <div className="flex w-full h-full mt-8">
        <div className="w-full md:w-1/3 lg:w-1/4">
          <div className="flex flex-col items-center justify-center h-full">
            ...
            <div className={`${Jersey15.className} text-3xl text-[#bbb] mt-2`}>
              Members Login
            </div>
            ...
            >
              {user && (
                <div className="text-[#bbb] ">Signed in as: {user.email}</div>
              )}
              {error && <div className="text-red-500 opacity-90">{error}</div>}
            </div>
          </div>
        </div>
